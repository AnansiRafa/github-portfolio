let recipe = {
  ...
  ingredients: [
    ...
    },
    {
      amount: 1,
      measurement: "cup",
      ingredient: "pomegranate glaze"
    }],

    directions: ["In a small bowl, mix together fennel, salt, lavender, and coriander. Place duck breasts, skin up, in a large dish. Sprinkle evenly with the spice mixture. Flip breasts over and place the zest, brandy, and thyme evenly on the flesh; let marinate for 30 minutes.",
